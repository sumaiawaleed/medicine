...
class CollectorController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware(['permission:collectors-read'])->only('index', 'show');
        $this->middleware(['permission:collectors-create'])->only('create', 'store');
        $this->middleware(['permission:collectors-update'])->only('edit', 'update');
        $this->middleware(['permission:collectors-delete'])->only('destroy');
    }//end of constructor

    public function index(EmployeeDataTable $dataTable,Request $request){
        $data['title'] = __('site.collectors');
        return $dataTable->render('dashboard.people.collectors.index',compact('data'));
    }
    ...
    public function show($id){
        ...
        return view('dashboard.people.collectors.show',compact('data','form_data'));
    }
    ...
    {
        $form_data = User::findOrFail($id);
        $returnHTML = view('dashboard.people.collectors.partials._edit',compact('form_data'))->render();
        return $returnHTML;
    }
    ...
    public function invoices($id){
        ...
        return $dataTable->render('dashboard.people.collectors.functions._invoices',compact('data'));
    }
    ...
    public function orders($id){
        ...
        return $dataTable->render('dashboard.people.collectors.functions._orders',compact('data'));
    }
    ...
    public function tasks($id){
        ...
        return $dataTable->render('dashboard.people.collectors.functions._tasks',compact('data'));
    }
    ...
    public function locations($id){
        ...
        return $dataTable->render('dashboard.people.collectors.functions._locations',compact('data'));
    }
}
