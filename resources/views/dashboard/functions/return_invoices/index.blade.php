...
@section('content')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route(env('DASH_URL').'.invoices.index') }}">@lang('site.invoices')</a>
                            </li>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        @if (auth()->user()->hasPermission('return_invoices-create'))
    ...
    @if (auth()->user()->hasPermission('return_invoices-create'))
        @include('dashboard.functions.return_invoices.create_model')
    @endif
    @if (auth()->user()->hasPermission('return_invoices-update'))
        @include('dashboard.functions.return_invoices.edit_model')
    @endif
