...
<div class="row">
    <div class="col-md-12">
        <div class="form-group" id="total_amount_edit_div">
            <label
                for="total_amount_edit_input">@lang('site.total_amount')</label>
            <input name="total_amount" type="text" value="{{ $form_data->total_amount }}"
                   class="form-control" id="total_amount_edit_input"
                   placeholder="@lang('site.total_amount')">
            <span id="total_amount_edit_error" class="help-block"></span>
        </div>
    </div>
</div>
