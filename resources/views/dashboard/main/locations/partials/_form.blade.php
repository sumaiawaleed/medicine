@php
    ...
    $is_current = isset($form_data) ? $form_data->is_current : 0;
@endphp
<div class="row">
...
<div class="row">
    ...
    <div class="col-md-4">
        <label
            for="area_id_input">@lang('site.is_current')</label>
        <div class="form-group">
            <input type="checkbox" name="is_current" value="1" {{ $is_current == 1 ? 'checked' : '' }}> @lang('site.is_current')
        </div>
    </div>
