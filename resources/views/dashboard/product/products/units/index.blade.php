...
@section('content')
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        @if (auth()->user()->hasPermission('product_units-create'))
    ...
    @if (auth()->user()->hasPermission('product_units-create'))
        @include('dashboard.product.products.units.create_model')
    @endif
    @if (auth()->user()->hasPermission('product_units-update'))
        @include('dashboard.product.products.units.edit_model')
    @endif
