                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route(env('DASH_URL').'.clients.index') }}">@lang('site.clients')</a>
                            </li>
                        ...
                        <div class="card">
                            <div class="card-header p-2">
                                <ul class="nav nav-pills">
                                    <li class="nav-item"><a href="{{ route(env('DASH_URL').'.clients.show',$data['user']->id) }}" class="nav-link {{ $data['page'] == 'edit' ? 'active' : '' }}">@lang('site.edit')</a>
                                    </li>
                                    <li class="nav-item"><a href="{{ route(env('DASH_URL').'.clients.orders',$data['user']->id) }}" class="nav-link {{ $data['page'] == 'orders' ? 'active' : '' }}" >@lang('site.orders')</a></li>
